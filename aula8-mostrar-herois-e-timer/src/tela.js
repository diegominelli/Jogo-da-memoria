...
class Tela {
  ...
  static iniciarContador() {
    ...
    // onde esta o $$contador adicionaresmos o valor 
    const indetificadorNoTexto = "$$contador"
    const textoPadrao = `Começando em ${indetificadorNoTexto} segundos...`
    // vamos criar uma funcao em linha para atualizar o texto
    // a cada segundo
    const atualizarTexto = () => 
    (elementoContador.innerHTML = textoPadrao.replace(indetificadorNoTexto, contarAte--))
    ...
    // retornamos o idDoIntevalo para parar ele mais tarde 
